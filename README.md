# pagopa-ecommerce-payment-methods-handler-service
...
You can then execute your native executable with: `./build/pagopa-ecommerce-payment-methods-handler-service-1.0.0-SNAPSHOT-runner`
